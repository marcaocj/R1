...
public class SkillEffect : ScriptableObject
{
    ...
    public void ApplyEffect(GameObject target, GameObject caster = null)
    {
        ...
        // Criar dados do efeito
        StatusEffectManager.SkillEffectData effectData = new StatusEffectManager.SkillEffectData();
        effectData.effectType = ConvertToStatusEffectType(effectType);
        effectData.value = value;
        effectData.duration = duration;
        effectData.tickInterval = tickInterval;
        effectData.isPersistent = isPersistent;
        
        // Adicionar modificadores de stat
        foreach (StatModifierData modifier in statModifiers)
        {
            StatusEffectManager.StatModifierData statMod = new StatusEffectManager.StatModifierData(
                ConvertToStatType(modifier.statName), 
                modifier.value, 
                modifier.isPercentage
            );
            effectData.statModifiers.Add(statMod);
        }
        
        // Aplicar o efeito
        statusManager.AddEffect(effectData.effectType, duration, effectData);
    ...
    public void RemoveEffect(GameObject target)
    {
        ...
        if (statusManager != null)
        {
            StatusEffectManager.StatusEffectType effectTypeConverted = ConvertToStatusEffectType(effectType);
            statusManager.RemoveEffect(effectTypeConverted);
        }
    }
    ...
    private StatusEffectManager.StatusEffectType ConvertToStatusEffectType(EffectType effectType)
    {
        switch (effectType)
        {
            case EffectType.DamageOverTime: return StatusEffectManager.StatusEffectType.Poison;
            case EffectType.HealOverTime: return StatusEffectManager.StatusEffectType.Regeneration;
            case EffectType.Heal: return StatusEffectManager.StatusEffectType.Heal;
            case EffectType.Buff: return StatusEffectManager.StatusEffectType.Strength;
            case EffectType.Debuff: return StatusEffectManager.StatusEffectType.Weakness;
            case EffectType.Root: return StatusEffectManager.StatusEffectType.Stun;
            case EffectType.Slow: return StatusEffectManager.StatusEffectType.Slow;
            case EffectType.Stun: return StatusEffectManager.StatusEffectType.Stun;
            case EffectType.Silence: return StatusEffectManager.StatusEffectType.Silence;
            case EffectType.ManaRegeneration: return StatusEffectManager.StatusEffectType.ManaBoost;
            default: return StatusEffectManager.StatusEffectType.Poison;
        }
    }
    
    private StatusEffectManager.StatType ConvertToStatType(string statName)
    {
        switch (statName.ToLower())
        {
            ...
            case "defense": return StatusEffectManager.StatType.Defense;
            case "speed": return StatusEffectManager.StatType.Speed;
